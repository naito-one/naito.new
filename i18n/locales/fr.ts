export default {
  ...
  allValues: {
    ...
    inclusive: {
      header: 'Web inclusif',
      content:
        'Accessibilité, multilinguisme, thèmes claires/foncés, support des périphériques anciens & lents, support pour tous les navigateurs principaux, sites web majoritairement fonctionnels sans JavaScript.',
    },
    proud: {
      header: 'Web fier',
      content:
        "Pas de sites web pour des activités violentes/exploitantes/malhonnête, pas de contenu bâclé IA, pas d'entrainement IA sur les données de nos clients, pas de profilage sournois, règles compréhensibles par des humains, partage de code & resources & connaissances. Contribution à des projets open source.",
    },
  },
}
